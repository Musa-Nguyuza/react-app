...
const ViewProductRisk = () => {
  const { id } = useParams();
  const navigate = useNavigate();
  const { tableData, loading, error } = useFetchTableData(id, 'Product Risk Table');
  const tableName="Product Risk Table";
  ...
  return (
    <>
      ...
      <Button 
        ...
        onClick={() => navigate(`/view-processqa/${id}`)}>
        Next
      </Button>
    </>
  );
...
export default ViewProductRisk;
