...
const ViewCustomerExp = () => {
  const { id } = useParams();
  const navigate = useNavigate();
  const { tableData, loading, error } = useFetchTableData(id, 'Customer Experience Table');
  const tableName="Customer Experience Table";
...
export default ViewCustomerExp;
