...
const ViewMarketConduct = () => {
  const { id } = useParams();
  const navigate = useNavigate();
  const { tableData, loading, error } = useFetchTableData(id, 'Market Conduct Table');
  const tableName ="Market Conduct Table"
  ...
  return (
    <>
      ...
      <Button 
        ...
        onClick={() => navigate(`/view-productrisk/${id}`)}>
        Next
      </Button>
    </>
  );
...
export default ViewMarketConduct;
