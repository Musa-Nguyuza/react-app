...
const ViewProcessQa = () => {
  ...
  const { tableData, loading, error } = useFetchTableData(id, 'Process Table');
  const tableName = "Process Table";
  ...
  return (
    <>
      ...
      <Button 
        ...
        onClick={() => navigate(`/view-customerexp/${id}`)}>
        Next
      </Button>
    </>
  );
